...
export default function HomePage() {
  const features = [
    {
      title: "Observability",
      desc: "Consolidate your logs, metrics, application traces, and system availability with purpose-built UIs."
    },
    {
      title: "Security",
      desc: "Prevent, collect, detect, and respond to threats for unified protection across your infrastructure."
    },
    {
      title: "Analytics",
      desc: "Explore, visualize, and analyze your data using a powerful suite of analytical tools and applications."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-primary text-white p-8">
      ...
      <FaBars className="text-2xl mb-3 cursor-pointer hover:text-third transition-colors" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        {features.map((feature, index) => (
          ...
          >
            {/* مكان الأيقونة أو الصورة في الكارت */}
      ...
      <div>
        ...
        <p className="text-gray-400 max-w-xl mb-10 leading-relaxed">
          ...
          Collect data from an app or service, or upload a file. If you're not ready 
          to use your own data, play with a sample data set.
        </p>
        ...
        <div className="flex flex-wrap gap-6 items-center">
          ...
          <button className="flex items-center cursor-pointer gap-2 text-white font-semibold hover:text-third transition-all">
             Try sample data
          </button>
          
          <button className="flex items-center gap-2 cursor-pointer text-white font-semibold hover:text-third transition-all">
             Upload a file
          </button>
        </div>
      </div>
